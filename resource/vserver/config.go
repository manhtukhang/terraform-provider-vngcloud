...
var (
	...
	externalNetworkInterfaceCreating = []string{"CREATING", "CREATING-BILLING"}
	externalNetworkInterfaceCreated  = []string{"ACTIVE"}
	externalNetworkInterfaceDeleting = []string{"DELETING"}
	externalNetworkInterfaceDeleted  = []string{"DELETED"}
