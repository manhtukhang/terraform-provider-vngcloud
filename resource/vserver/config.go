...
var (
	...
	networkInterfaceElasticCreating = []string{"CREATING", "CREATING-BILLING"}
	networkInterfaceElasticCreated  = []string{"ACTIVE"}
	networkInterfaceElasticDeleting = []string{"DELETING"}
	networkInterfaceElasticDeleted  = []string{"DELETED"}
